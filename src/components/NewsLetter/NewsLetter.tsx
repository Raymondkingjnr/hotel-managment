const NewsLetter = () => {
  return (
    <section className="container mx-auto px-4">
      <form className="bg-primary text-white px-4 rounded-sm flex flex-col justify-center items-center py-6 md:py-24">
        <p className="md:font-semibold text-xl text-center mb-3">
          Explore More About Our Hotel
        </p>
        <h6 className="md:font-semibold font-medium text-2xl  text-center">
